...
Thanks for stopping by!  =)`
	...
	},
	{
		...
		type: 'Project',
		description: 'One of my very first projects. The classic game of Tic-Tac-Toe!',
		links: [
			{ name: 'Project Repo', link: 'https://github.com/99slayer/odin-tic-tac-toe' },
			{ name: 'Project Demo', link: 'https://99slayer.github.io/odin-tic-tac-toe' }
		],
		images: [
			'./images/project-tic-tac-toe/tic-tac-toe-1.png'
		]
	},
	{
		name: 'About Me',
		type: 'Text',
		text: import.meta.env.VITE_ABOUT
	}
];
